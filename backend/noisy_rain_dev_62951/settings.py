"""
Django settings for noisy_rain_dev_62951 project.
...
ROOT_URLCONF = 'noisy_rain_dev_62951.urls'
...
WSGI_APPLICATION = 'noisy_rain_dev_62951.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_rain_dev_62951 API",
    "DESCRIPTION": "API documentation for noisy_rain_dev_62951 App",
    "VERSION": "v1",
}
